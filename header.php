...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="add_employe.php">Registration</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="show_gallery.php">Show Details</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="show_team.php">Edit Team</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="about.php">About</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="edit_aboutus.php">Edit About us</a>
      </li>
    </ul>
  </div>
</nav>
